            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-6 form-group">
                        <input type="text" class="form-control" name="month" value="{{$month}}" placeholder="Cari Bulan...">
                    </div>
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-primary me-1 mb-1">Tambah</button>
                        <a href="/print-data-bulanan-saya/{{$month}}" class="btn btn-primary me-1 mb-1" target="__blank">Print</a>
                    </div>
                </div>
            </div>
        </form>
